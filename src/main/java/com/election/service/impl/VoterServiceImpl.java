...
import com.election.utils.exception.BusinessException;
import com.election.utils.exception.ExceptionEnum;
...
public class VoterServiceImpl implements VoterService {
    ...
    private void voteCheck(VoteDTO.@NonNull Req req, RMap<String, ElectionBO> stringElectionBORMap, RMap<Object, Object> candidateCache) {
        ...
        //身份证合法性
        final var validHKCard = checkHKIdNumber(req.getVoterIdNumber());
